...
cp remote/CommonDataModel/inst/ddl/5.3/postgresql/OMOPCDM_postgresql_5.3_ddl.sql data/schema/ddl.sql
sed -i "s/@cdmDatabaseSchema/cdm/g" sql/schema/ddl.sql

cp remote/CommonDataModel/inst/ddl/5.3/postgresql/OMOPCDM_postgresql_5.3_primary_keys.sql data/schema/keys.sql
sed -i "s/@cdmDatabaseSchema/cdm/g" sql/schema/keys.sql

cp remote/CommonDataModel/inst/ddl/5.3/postgresql/OMOPCDM_postgresql_5.3_constraints.sql data/schema/constraints.sql
sed -i "s/@cdmDatabaseSchema/cdm/g" sql/schema/constraints.sql

cp remote/CommonDataModel/inst/ddl/5.3/postgresql/OMOPCDM_postgresql_5.3_indices.sql data/schema/indices.sql
