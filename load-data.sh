...
sed -i "s/@cdmDatabaseSchema/public/g" schema/ddl.sql
...
sed -i "s/@cdmDatabaseSchema/public/g" schema/keys.sql
...
sed -i "s/@cdmDatabaseSchema/public/g" schema/constraints.sql
...
sed -i "s/@cdmDatabaseSchema/public/g" schema/indices.sql
